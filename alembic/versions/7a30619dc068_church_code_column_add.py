...
def downgrade() -> None:
    ...
    op.drop_index('ix_users__id', 'tb_users', ['id'])
    op.drop_index('ix_users__email', 'tb_users', ['email'])
    op.drop_index('ix_churches__id', 'tb_churches', ['id'])
    op.drop_index('ix_churches__name', 'tb_churches', ['name'])
    op.drop_index('ix_church_admins__id', 'tb_church_admins', ['id'])
    op.drop_index('ix_bulletin_templates__id', 'tb_bulletin_templates', ['id'])
    op.drop_index('ix_bulletins__id', 'tb_bulletins', ['id'])
    op.drop_index('ix_bulletins__date', 'tb_bulletins', ['date'])
